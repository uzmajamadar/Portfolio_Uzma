...
interface ChartTooltipContentProps {
  ...
  labelFormatter?: (label: string | number, payload: Array<{
    name?: string
    dataKey?: string
    value?: number | string
    payload?: { fill?: string }
    ...
    return (
      ...
      >
        ...
        <div className="grid gap-1.5">
          {payload.map((item: { name?: string; dataKey?: string; value?: number | string; payload?: { fill?: string }; color?: string }, index: number) => {
